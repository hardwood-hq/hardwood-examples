...
/// Downloads the sample file this example serves so it "just runs" — no manual setup.
///
/// The file is one month of the public NYC TLC Yellow Taxi trip-record dataset, saved into a local
/// `data/` folder and reused if already present. [S3Proxy] then serves it over the S3 protocol, so
/// the reader streams it back exactly as it would from real Amazon S3.
