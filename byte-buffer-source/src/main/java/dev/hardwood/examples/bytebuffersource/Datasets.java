...
/// into a local `data/` folder. If it is already there, it is reused. This example only
/// downloads it to get some real Parquet bytes — it then reads them straight from memory.
